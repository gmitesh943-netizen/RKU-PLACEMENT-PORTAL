<%@ Page Title="" Language="C#" MasterPageFile="~/Admin-panel.Master" AutoEventWireup="true" CodeBehind="AdminReports.aspx.cs" Inherits="RKU_PLACEMENT_PORTAL.AdminReports" %>
...
<asp:Content ID="Content2" runat="server" contentplaceholderid="ContentPlaceHolder1">
                ...
                <head>
                    <meta charset="UTF-8">
                    <meta name="viewport" content="width=device-width, initial-scale=1.0"><title>Admin Dashboard | RK University Placement Portal</title>
             ...
             ========================================== -->
                        <aside class="sidebar" id="sidebar">
                            <div>
                                ...
                                <ul class="sidebar-menu">
                                    ...
                                    <li class="sidebar-item active" data-tab="tab-reports"><a href="AdminReports.aspx"><i class="fa-solid fa-chart-column"></i>Reports &amp; Analytics</a> </li>
                                </ul>
                            </div>
                        ...
                        <div class="main-panel">
                            ...
                            <main class="content-container">
                                ...
                                <div id="tab-reports" class="tab-pane-content active">

                                    <!-- KPI Cards Row -->
                                    <div class="row g-3 mb-4" id="reportKpiRow">
                                        <div class="col-sm-6 col-xl-2">
                                            <div class="report-kpi-card">
                                                <div class="report-kpi-icon" style="background: rgba(163,15,20,0.1); color: var(--rku-maroon);">
                                                    <i class="fa-solid fa-users"></i>
                                                </div>
                                                <div>
                                                    <div class="report-kpi-value" id="rpt-total-students">
                                                        0</div>
                                        ...
                                        <div class="col-sm-6 col-xl-2">
                                            <div class="report-kpi-card">
                                                <div class="report-kpi-icon" style="background: rgba(23,162,184,0.1); color: #17a2b8;">
                                                    <i class="fa-regular fa-building"></i>
                                                </div>
                                                <div>
                                                    <div class="report-kpi-value" id="rpt-total-drives">
                                                        0</div>
                                                    <div class="report-kpi-label">
                                                        Total Drives</div>
                                                </div>
                                        ...
                                        <div class="col-sm-6 col-xl-2">
                                            <div class="report-kpi-card">
                                                <div class="report-kpi-icon" style="background: rgba(255,193,7,0.1); color: #ffc107;">
                                                    <i class="fa-solid fa-file-circle-check"></i>
                                                </div>
                                                <div>
                                                    <div class="report-kpi-value" id="rpt-total-apps">
                                                        0</div>
                                                    <div class="report-kpi-label">
                                                        Applications</div>
                                                </div>
                                        ...
                                        <div class="col-sm-6 col-xl-2">
                                            <div class="report-kpi-card">
                                                <div class="report-kpi-icon" style="background: rgba(40,167,69,0.1); color: #28a745;">
                                                    <i class="fa-solid fa-user-check"></i>
                                                </div>
                                                <div>
                                                    <div class="report-kpi-value" id="rpt-placed">
                                                        0</div>
                                                    <div class="report-kpi-label">
                                                        Students Placed</div>
                                                </div>
                                        ...
                                        <div class="col-sm-6 col-xl-2">
                                            <div class="report-kpi-card">
                                                <div class="report-kpi-icon" style="background: rgba(111,66,193,0.1); color: #6f42c1;">
                                                    <i class="fa-solid fa-percent"></i>
                                                </div>
                                                <div>
                                                    <div class="report-kpi-value" id="rpt-rate">
                                                        0%</div>
                                                    <div class="report-kpi-label">
                                                        Placement Rate</div>
                                                </div>
                                        ...
                                        <div class="col-sm-6 col-xl-2">
                                            <div class="report-kpi-card">
                                                <div class="report-kpi-icon" style="background: rgba(253,126,20,0.1); color: #fd7e14;">
                                                    <i class="fa-solid fa-indian-rupee-sign"></i>
                                                </div>
                                                <div>
                                                    <div class="report-kpi-value" id="rpt-avg-pkg">
                                                        —</div>
                                                    <div class="report-kpi-label">
                                                        Avg Package</div>
                                                </div>
                                    ...
                                    <div class="row g-4 mb-4">
                                        <div class="col-lg-7">
                                            <div class="dashboard-card">
                                                <h5 class="report-section-title"><i class="fa-solid fa-chart-bar text-rku-red"></i>Placement Rate by Department</h5>
                                                <div class="chart-container-wrapper">
                                                    <canvas id="rptChartBranch"></canvas>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-lg-5">
                                            <div class="dashboard-card">
                                                <h5 class="report-section-title"><i class="fa-solid fa-chart-pie text-rku-maroon"></i>Application Status Breakdown</h5>
                                                <div class="chart-container-wrapper">
                                    ...
                                    <div class="report-table-wrapper mb-4">
                                        <div class="report-table-head">
                                            <div class="report-section-title mb-0">
                                                <i class="fa-solid fa-graduation-cap text-rku-maroon"></i>Department-wise Placement Summary</div>
                                            <input type="text" class="form-control form-control-sm" id="rptDeptSearch" placeholder="Search department..." style="max-width: 220px;" oninput="filterReportTable('rptDeptTableBody','rptDeptSearch')">
                                        </div>
                                        <div class="report-table-body">
                                            <div class="table-responsive">
                                                <table class="table table-hover align-middle mb-0" id="rptDeptTable">
                                    ...
                                    <!-- Drive-wise Applicant Summary Table -->
                                    <div class="report-table-wrapper mb-4">
                                        <div class="report-table-head">
                                            <div class="report-section-title mb-0">
                                                <i class="fa-regular fa-building text-primary"></i>Drive-wise Applicant Summary</div>
                                            <input type="text" class="form-control form-control-sm" id="rptDriveSearch" placeholder="Search company..." style="max-width: 220px;" oninput="filterReportTable('rptDriveTableBody','rptDriveSearch')">
                                        </div>
                                        <div class="report-table-body">
                                            <div class="table-responsive">
                                    ...
                                    <div class="report-table-wrapper">
                                        <div class="report-table-head">
                                            <div class="report-section-title mb-0">
                                                <i class="fa-solid fa-list-check text-success"></i>Placed Students – Full List</div>
                                            <div class="d-flex gap-2">
                                                <input type="text" class="form-control form-control-sm" id="rptPlacedSearch" placeholder="Search student..." style="max-width: 180px;" oninput="filterPlacedTable()">
                                                <select class="form-select form-select-sm" id="rptPlacedBranchFilter" onchange="filterPlacedTable()" style="max-width: 150px;">
                                                ...
                                                <button class="export-csv-btn" onclick="exportPlacedStudentsCSV()">
                    ...
                    <!-- Reports & Analytics JavaScript Controller -->
                    <script>
            ...
            `;
                ...
                `;
                        ...
                        function editStory(id) {
                            ...
                            const fInput = document.getElementById('storyName');
                            if (fInput) fInput.focus({ preventScroll: true });
                        }
                ...
                `;
                        ...
                        function editPlacementTeamMember(id) {
                            ...
                            const fInput = document.getElementById('teamName');
                            if (fInput) fInput.focus({ preventScroll: true });
                        }
                ...
                `;
                        ...
                        function editPlacedStudent(id) {
                            ...
                            const fInput = document.getElementById('placedStudentName');
                            if (fInput) fInput.focus({ preventScroll: true });
                        }
                ...
                `;
                        ...
                        function editGalleryItem(id) {
                            ...
                            const fInput = document.getElementById('galleryTitle');
                            if (fInput) fInput.focus({ preventScroll: true });
                        }
                ...
                `;
                        ...
                        function editCompany(id) {
                            ...
                            const fInput = document.getElementById('companyName');
                            if (fInput) fInput.focus({ preventScroll: true });
                        }
