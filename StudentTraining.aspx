...
<asp:Content ID="Content2" runat="server" ContentPlaceHolderID="ContentPlaceHolder1">
    ...
    <head>
        ...
        <title>Training Hub | RK University Placement Portal</title>
        <meta name="description" content="Practice aptitude, coding, resume building, and interview skills in the RK University Student Panel.">
            ...
            <aside class="sidebar" id="sidebar">
                <div>
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="sidebar-item active" data-page="training"><a href="StudentTraining.aspx"><i class="fa-solid fa-graduation-cap"></i>Training Hub</a></li>
                    </ul>
                </div>
            ...
            <div class="main-panel">
                <header class="top-navbar d-flex justify-content-between align-items-center">
                    <div class="d-flex align-items-center">
                        ...
                        <h4 class="mb-0 text-dark fw-bold page-title" id="panelTitle">Training Hub</h4>
                    </div>
