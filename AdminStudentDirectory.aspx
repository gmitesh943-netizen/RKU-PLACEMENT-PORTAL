<%@ Page Title="" Language="C#" MasterPageFile="~/Admin-panel.Master" AutoEventWireup="true" CodeBehind="AdminStudentDirectory.aspx.cs" Inherits="RKU_PLACEMENT_PORTAL.AdminStudentDirectory" %>
             ...
             ========================================== -->
                        <aside class="sidebar" id="sidebar">
                            <div>
                                ...
                                <ul class="sidebar-menu">
                                    ...
                                    <li class="sidebar-item active" data-tab="tab-student-directory"><a href="AdminStudentDirectory.aspx"><i class="fa-solid fa-users"></i>Student Directory</a> </li>
                        ...
                        <div class="main-panel">
                            ...
                            <main class="content-container">
                                ...
                                <div id="tab-student-directory" class="tab-pane-content active">
                                    <div class="dashboard-card">
                                        <div class="row g-3 mb-4 justify-content-between align-items-center">
                                            ...
                                            <div class="col-md-7 d-flex gap-2 justify-content-end">
                                                ...
                                                <select class="form-select form-select-sm" id="studentBranchFilter" onchange="filterStudentTable()" style="max-width: 140px;">
                    ...
                    <!-- Student Directory JavaScript Controller -->
                    <script>
