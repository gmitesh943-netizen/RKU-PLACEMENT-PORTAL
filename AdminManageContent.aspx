<%@ Page Title="" Language="C#" MasterPageFile="~/Admin-panel.Master" AutoEventWireup="true" CodeBehind="AdminManageContent.aspx.cs" Inherits="RKU_PLACEMENT_PORTAL.AdminManageContent" %>
...
<asp:Content ID="Content2" runat="server" ContentPlaceHolderID="ContentPlaceHolder1">
    ...
    <body>
        ...
        <div class="wrapper">
            ...
            <aside class="sidebar" id="sidebar">
                <div>
                    ...
                    <ul class="sidebar-menu">
                        <li class="sidebar-item" data-tab="tab-overview"><a href="AdminDashboard.aspx"><i class="fa-solid fa-chart-line"></i>Overview</a> </li>
                        ...
                        <li class="sidebar-item active" data-tab="tab-manage-content"><a href="AdminManageContent.aspx"><i class="fa-solid fa-photo-film"></i>Manage Web Content</a> </li>
            ...
            <div class="main-panel">
                ...
                <header class="top-navbar d-flex justify-content-between align-items-center gap-3">
                    ...
                    <div class="global-search-wrapper mx-2 flex-grow-1">
                        ...
                        <input type="text" class="global-search-input" id="globalSearchInput"
                            placeholder="Search students, drives, announcements..." autocomplete="off">
                    ...
                    <div class="d-flex align-items-center gap-3 flex-shrink-0">
                        <div class="d-flex align-items-center text-end">
                            ...
                            <div class="bg-rku-red fw-bold rounded-circle d-flex align-items-center justify-content-center text-white"
                                 style="width:40px; height:40px; font-size:1rem; flex-shrink:0;">AD</div>
                        </div>
                    </div>
                </header>
                ...
                <main class="content-container">
                    ...
                    <!-- ─── MANAGE CONTENT TAB ─── -->
                    <div id="tab-manage-content" class="tab-pane-content active">
                ...
                <div class="section-header mb-4">
                    ...
                    <div>
                        ...
                        <p>
                            Manage placed student stories shown on the website
                        </p>
                    </div>
                </div>
                <div class="row g-4 mb-5">
                    ...
                    <div class="col-xl-7 col-lg-6">
                        <div class="content-section h-100">
                            <div class="content-section-head d-flex align-items-center justify-content-between">
                                <div class="d-flex align-items-center gap-2">
                                    <div class="fw-bold font-heading" style="font-size: 0.9rem;">
                                        <i class="fa-solid fa-list me-2 text-muted"></i>All Stories
                                    </div>
                                    <span class="badge bg-light text-muted border" id="storyCountBadge">0 stories</span>
                                </div>
                                <button type="button" class="btn btn-rku btn-sm text-nowrap" onclick="cancelEditStory()"><i class="fa-solid fa-plus me-1"></i>Add New Story</button>
                            </div>
                            ...
                            <div class="form-panel-head">
                                ...
                                <div id="storyForm">
                                    ...
                                    <div class="d-grid gap-2 mt-3">
                                        <button type="button" class="btn btn-rku btn-sm" id="storySubmitBtn" onclick="saveStory(event)">
                ...
                <div class="section-header mb-4">
                    ...
                    <div>
                        ...
                        <p>
                            Upload photos shown in the gallery section of the website
                        </p>
                    </div>
                </div>
                <div class="row g-4 mb-5">
                            ...
                            <div class="form-panel-body">
                                <div id="galleryForm">
                                    ...
                                    <div class="d-grid gap-2">
                                        <button type="button" class="btn btn-rku btn-sm" id="gallerySubmitBtn" onclick="saveGalleryItem(event)">
                ...
                <!-- ══════════════════════════════════════
                         SECTION 3: PLACEMENT TEAM
                    ══════════════════════════════════════ -->
                <div class="section-header mb-4">
                    <div class="section-header-icon" style="background: rgba(239,55,36,0.1); color: var(--rku-red);">
                        <i class="fa-solid fa-user-tie"></i>
                    </div>
                    <div>
                        <h5>Placement Team</h5>
                        <p>
                            Manage coordinators shown in the About Us placement team section
                        </p>
                    </div>
                </div>
                <div class="row g-4 mb-5">
                    <div class="col-xl-7 col-lg-6">
                        <div class="content-section h-100">
                            <div class="content-section-head">
                                <div class="fw-bold font-heading" style="font-size: 0.9rem;">
                                    <i class="fa-solid fa-id-card me-2 text-muted"></i>Team Members
                                </div>
                                <div class="d-flex align-items-center gap-2">
                                    <span class="badge bg-light text-muted border" id="placementTeamCountBadge">0 members</span>
                                    <button type="button" class="btn btn-sm btn-outline-success border-0 fw-semibold" onclick="cancelEditPlacementTeamMember(event)" title="Add New Team Member">
                                        <i class="fa-solid fa-plus me-1"></i>Add New
                                    </button>
                                </div>
                            </div>
                            <div class="content-section-body no-pad">
                                <div id="adminPlacementTeamList" style="max-height: 620px; overflow-y: auto;">
                                    <!-- Loaded dynamically -->
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-xl-5 col-lg-6">
                        <div class="form-panel" style="position: sticky; top: 20px;">
                            <div class="form-panel-head">
                                <h6 class="fw-bold mb-0 font-heading" id="placementTeamFormTitle"><i class="fa-solid fa-user-plus me-2 text-rku-red"></i>Add Team Member</h6>
                            </div>
                            <div class="form-panel-body">
                                <div id="placementTeamForm">
                                    <input type="hidden" id="editPlacementTeamId" value="">
                                    <div class="mb-3">
                                        <label class="form-label text-muted small fw-bold">
                                            Member Name</label>
                                        <input type="text" class="form-control" id="teamMemberName" placeholder="e.g. Amit Sir" required>
                                    </div>
                                    <div class="mb-3">
                                        <label class="form-label text-muted small fw-bold">
                                            Designation</label>
                                        <input type="text" class="form-control" id="teamMemberDesignation" placeholder="e.g. Lead Coordinator" required>
                                    </div>
                                    <div class="mb-3">
                                        <label class="form-label text-muted small fw-bold">
                                            Short Role / Subtitle</label>
                                        <input type="text" class="form-control" id="teamMemberRole" placeholder="e.g. Placement Coordination & Student Support" required>
                                    </div>
                                    <div class="mb-3">
                                        <label class="form-label text-muted small fw-bold">
                                            Description</label>
                                        <textarea class="form-control" id="teamMemberDescription" rows="3" placeholder="Short profile description..." required></textarea>
                                    </div>
                                    <div class="row g-2 mb-3">
                                        <div class="col-6">
                                            <label class="form-label text-muted small fw-bold">
                                                Phone</label>
                                            <input type="text" class="form-control" id="teamMemberPhone" placeholder="+91 98765 43210">
                                        </div>
                                        <div class="col-6">
                                            <label class="form-label text-muted small fw-bold">
                                                Order</label>
                                            <input type="number" min="1" class="form-control" id="teamMemberOrder" placeholder="1" required>
                                        </div>
                                    </div>
                                    <div class="mb-3">
                                        <label class="form-label text-muted small fw-bold">
                                            Email</label>
                                        <input type="email" class="form-control" id="teamMemberEmail" placeholder="placement@rku.ac.in">
                                    </div>
                                    <div class="mb-3">
                                        <label class="form-label text-muted small fw-bold">
                                            Team Photo (Optional)</label>
                                        <label for="teamMemberPhoto" class="img-upload-zone d-block">
                                            <img id="teamMemberImagePreview" src="" style="width: 90px; height: 90px; object-fit: cover; border-radius: 10px; margin: 0 auto 10px; display: none;">
                                            <div id="teamMemberUploadHint">
                                                <i class="fa-solid fa-cloud-arrow-up fa-2x text-muted mb-2 d-block"></i><span class="text-muted small">Click to upload team photo</span>
                                            </div>
                                        </label>
                                        &nbsp;<input type="file" class="d-none" id="teamMemberPhoto" accept="image/*" onchange="previewPlacementTeamImage(this)">
                                    </div>
                                    <div class="form-check mb-3">
                                        <input class="form-check-input" type="checkbox" id="teamMemberIsFeatured">
                                        <label class="form-check-label small fw-semibold" for="teamMemberIsFeatured">
                                            Mark as featured member
                                        </label>
                                    </div>
                                    <div class="d-grid gap-2 mt-3">
                                        <button type="button" class="btn btn-rku btn-sm" id="placementTeamSubmitBtn" onclick="savePlacementTeamMember(event)">
                                            <i class="fa-solid fa-plus me-1"></i>Add Team Member
                                        </button>
                                        <button type="button" class="btn btn-outline-secondary btn-sm" id="placementTeamCancelBtn" style="display: none;" onclick="cancelEditPlacementTeamMember()">
                                            <i class="fa-solid fa-xmark me-1"></i>Cancel Edit
                                        </button>
                                    </div>
                                </div>
                ...
                <!-- ══════════════════════════════════════
                         SECTION 4: PLACED STUDENTS
                    ══════════════════════════════════════ -->
                <div class="section-header mb-4">
                    <div class="section-header-icon" style="background: rgba(15,118,110,0.1); color: #0f766e;">
                        <i class="fa-solid fa-user-graduate"></i>
                    </div>
                    <div>
                        <h5>Placed Students</h5>
                        <p>
                            Add the student cards that appear on the Student Selection page
                        </p>
                    </div>
                </div>
                <div class="row g-4 mb-5">
                    <div class="col-xl-7 col-lg-6">
                        <div class="content-section h-100">
                            <div class="content-section-head d-flex align-items-center justify-content-between">
                                <div class="d-flex align-items-center gap-2">
                                    <div class="fw-bold font-heading" style="font-size: 0.9rem;">
                                        <i class="fa-solid fa-list me-2 text-muted"></i>Student Cards
                                    </div>
                                    <span class="badge bg-light text-muted border" id="placedStudentCountBadge">0 students</span>
                                </div>
                                <button type="button" class="btn btn-rku btn-sm text-nowrap" onclick="cancelEditPlacedStudent()"><i class="fa-solid fa-plus me-1"></i>Add Placed Student</button>
                            </div>
                            <div class="content-section-body no-pad">
                                <div id="adminPlacedStudentsList" style="max-height: 580px; overflow-y: auto;">
                                    <!-- Loaded dynamically -->
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-xl-5 col-lg-6">
                        <div class="form-panel" style="position: sticky; top: 20px;">
                            <div class="form-panel-head">
                                <h6 class="fw-bold mb-0 font-heading" id="placedStudentFormTitle"><i class="fa-solid fa-user-plus me-2 text-rku-maroon"></i>Add Placed Student</h6>
                            </div>
                            <div class="form-panel-body">
                                <div id="placedStudentForm">
                                    <input type="hidden" id="editPlacedStudentId" value="">
                                    <div class="mb-3">
                                        <label class="form-label text-muted small fw-bold">
                                            Student Full Name</label>
                                        <input type="text" class="form-control" id="placedStudentName" placeholder="e.g. Atharv Virchand Shahiyta" required>
                                    </div>
                                    <div class="mb-3">
                                        <label class="form-label text-muted small fw-bold">
                                            Department / Branch</label>
                                        <input type="text" class="form-control" id="placedStudentDept" placeholder="e.g. B.Tech Computer Engineering" required>
                                    </div>
                                    <div class="row g-2 mb-3">
                                        <div class="col-6">
                                            <label class="form-label text-muted small fw-bold">
                                                Type</label>
                                            <select class="form-select" id="placedStudentType" required>
                                        ...
                                        <div class="col-6">
                                            <label class="form-label text-muted small fw-bold">
                                                Year</label>
                                            <select class="form-select" id="placedStudentYear" required>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="placedStudentCompany" placeholder="e.g. AUM Tech Solutions" required>
                                    </div>
                                    <div class="mb-3">
                                        <label class="form-label text-muted small fw-bold">
                                            Student Photo (Optional)</label>
                                        <label for="placedStudentPhoto" class="img-upload-zone d-block">
                                            <img id="placedStudentImagePreview" src="" style="width: 80px; height: 80px; object-fit: cover; border-radius: 10px; margin: 0 auto 10px; display: none;">
                                            <div id="placedStudentUploadHint">
                                                <i class="fa-solid fa-cloud-arrow-up fa-2x text-muted mb-2 d-block"></i><span class="text-muted small">Click to upload student photo</span>
                                            </div>
                                        </label>
                                        &nbsp;<input type="file" class="d-none" id="placedStudentPhoto" accept="image/*" onchange="previewPlacedStudentImage(this)">
                                    </div>
                                    <div class="d-grid gap-2 mt-3">
                                        <button type="button" class="btn btn-rku btn-sm" id="placedStudentSubmitBtn" onclick="savePlacedStudent(event)">
                                            <i class="fa-solid fa-cloud-arrow-up me-1"></i>Publish Student Card
                                        </button>
                                        <button type="button" class="btn btn-outline-secondary btn-sm" id="placedStudentCancelBtn" style="display: none;" onclick="cancelEditPlacedStudent()">
                                            <i class="fa-solid fa-xmark me-1"></i>Cancel Edit
                                        </button>
                                    </div>
                                </div>
                ...
                <div class="section-header mb-4">
                    ...
                    <div>
                        ...
                        <p>
                            Add and manage recruiting companies shown on the Companies page
                        </p>
                    </div>
                </div>
                <div class="row g-4 mb-5">
                    ...
                    <div class="col-xl-7 col-lg-6">
                        <div class="content-section h-100">
                            <div class="content-section-head">
                                <div class="fw-bold font-heading" style="font-size: 0.9rem;">
                                    <i class="fa-solid fa-list me-2 text-muted"></i>Companies List
                                </div>
                                <div class="d-flex align-items-center gap-2">
                                    <span class="badge bg-light text-muted border" id="companyCountBadge">0 companies</span>
                                    <button class="btn btn-sm btn-outline-success border-0 fw-semibold" onclick="cancelEditCompany()" title="Add New Company">
                                        <i class="fa-solid fa-plus me-1"></i>Add New
                                    </button>
                                </div>
                            </div>
                        ...
                        <div class="form-panel" style="position: sticky; top: 20px;">
                            ...
                            <div class="form-panel-body">
                                <div id="companyForm">
                                    ...
                                    <div class="d-grid gap-2 mt-3">
                                        <button type="button" class="btn btn-rku btn-sm" id="companySubmitBtn" onclick="saveCompany(event)">
        ...
        <!-- Manage Content JavaScript Controller -->
        <script>
            document.addEventListener('DOMContentLoaded', function() {
                if (typeof renderStoriesList === 'function') renderStoriesList();
                if (typeof renderPlacementTeamList === 'function') renderPlacementTeamList();
                if (typeof renderPlacedStudentsList === 'function') renderPlacedStudentsList();
            ...
            function openAddStudentModal() {
                ...
                if (form) form.reset();
                const passInput = document.getElementById('newStudentPassword');
                if (passInput) passInput.value = 'student123';
                const modalEl = document.getElementById('addStudentModal');
                if (modalEl) {
                    if (!addStudentModalInstance) {
                        addStudentModalInstance = new bootstrap.Modal(modalEl);
                    }
            ...
            function saveNewStudent(e) {
                ...
                const degree = document.getElementById('newStudentDegree').value;
                const branch = document.getElementById('newStudentBranch').value;
                const semester = document.getElementById('newStudentSemester').value;
                const cgpa = document.getElementById('newStudentCgpa').value.trim() || '0.0';
                const backlogs = document.getElementById('newStudentBacklogs').value.trim() || '0';
                ...
                if (!name || !enrollment || !email) {
                    alert('Please fill out Name, Enrollment Number, and Email Address.');
                    return;
                }

                const newUser = {
                    username: enrollment.toLowerCase(),
                    name: name,
                ...
                const res = PortalDB.register(newUser);
                if (!res.success) {
                    alert(res.message || 'Error creating student account.');
                    return;
                }

                alert(`🎉 Student account for "${name}" (${enrollment}) created successfully!`);
                if (addStudentModalInstance) addStudentModalInstance.hide();

                if (typeof renderStudentDirectory === 'function') renderStudentDirectory();
            ...
            async function saveStory(e) {
                ...
                if (!studentName || !degreeBranch || !recruiterName || !packageLpa || !role || !quote || !skills) {
                    alert('Please fill out all required fields for the story.');
                    return;
                }
            ...
            function cancelEditStory(e) {
                if (e && e.preventDefault) e.preventDefault();
                document.getElementById('editStoryId').value = '';
                if (document.getElementById('storyName')) document.getElementById('storyName').value = '';
                if (document.getElementById('storyDegree')) document.getElementById('storyDegree').value = '';
                if (document.getElementById('storyPhoto')) document.getElementById('storyPhoto').value = '';
                if (document.getElementById('storyRecruiter')) document.getElementById('storyRecruiter').value = '';
                if (document.getElementById('storyPackage')) document.getElementById('storyPackage').value = '';
                if (document.getElementById('storyRole')) document.getElementById('storyRole').value = '';
                if (document.getElementById('storyQuote')) document.getElementById('storyQuote').value = '';
                if (document.getElementById('storySkills')) document.getElementById('storySkills').value = '';
                if (document.getElementById('storyRank')) document.getElementById('storyRank').value = '';
                const isHof = document.getElementById('storyIsHallOfFame');
                if (isHof) isHof.checked = false;
                document.getElementById('rankSelectGroup').style.display = 'none';
                const preview = document.getElementById('storyImagePreview');
            ...
            function renderPlacementTeamList() {
                ...
                members.forEach(m => {
                    ...
                    <div class="d-flex gap-1">
                        <button type="button" class="btn btn-outline-primary btn-sm border-0" onclick="editPlacementTeamMember(event, '${m.id}')" title="Edit Team Member"><i class="fa-regular fa-pen-to-square"></i></button>
                        <button type="button" class="btn btn-outline-danger btn-sm border-0" onclick="deletePlacementTeamMember(event, '${m.id}')" title="Delete Team Member"><i class="fa-regular fa-trash-can"></i></button>
                    </div>
                `;
                    list.appendChild(div);
                });
            ...
            function editPlacementTeamMember(e, id) {
                if (e && e.preventDefault) e.preventDefault();
            ...
            function cancelEditPlacementTeamMember(e) {
                if (e && e.preventDefault) e.preventDefault();
                ...
                if (document.getElementById('teamMemberDesignation')) document.getElementById('teamMemberDesignation').value = '';
                if (document.getElementById('teamMemberRole')) document.getElementById('teamMemberRole').value = '';
                if (document.getElementById('teamMemberDescription')) document.getElementById('teamMemberDescription').value = '';
                if (document.getElementById('teamMemberPhone')) document.getElementById('teamMemberPhone').value = '';
                if (document.getElementById('teamMemberEmail')) document.getElementById('teamMemberEmail').value = '';
                if (document.getElementById('teamMemberOrder')) document.getElementById('teamMemberOrder').value = '';
                const featured = document.getElementById('teamMemberIsFeatured');
                if (featured) featured.checked = false;
                document.getElementById('placementTeamFormTitle').textContent = 'Add Team Member';
                const submitBtn = document.getElementById('placementTeamSubmitBtn');
                if (submitBtn) submitBtn.innerHTML = '<i class="fa-solid fa-plus me-1"></i> Add Team Member';
                const cancelBtn = document.getElementById('placementTeamCancelBtn');
            ...
            function deletePlacementTeamMember(e, id) {
                if (e && e.preventDefault) e.preventDefault();
            ...
            async function savePlacedStudent(e) {
                ...
                if (!name || !dept || !company || !type || !year) {
            ...
            function cancelEditPlacedStudent(e) {
                if (e && e.preventDefault) e.preventDefault();
                document.getElementById('editPlacedStudentId').value = '';
                if (document.getElementById('placedStudentName')) document.getElementById('placedStudentName').value = '';
                if (document.getElementById('placedStudentPhoto')) document.getElementById('placedStudentPhoto').value = '';
                if (document.getElementById('placedStudentDept')) document.getElementById('placedStudentDept').value = '';
                if (document.getElementById('placedStudentCompany')) document.getElementById('placedStudentCompany').value = '';
                if (document.getElementById('placedStudentYear')) document.getElementById('placedStudentYear').value = '2024-25';
                if (document.getElementById('placedStudentType')) document.getElementById('placedStudentType').value = 'computer';
            ...
            async function saveGalleryItem(e) {
                ...
                if (!title) {
                    alert('Please enter a gallery event title.');
                    return;
                }
            ...
            function cancelEditGallery(e) {
                if (e && e.preventDefault) e.preventDefault();
                document.getElementById('editGalleryId').value = '';
                if (document.getElementById('galleryTitle')) document.getElementById('galleryTitle').value = '';
                if (document.getElementById('galleryCategory')) document.getElementById('galleryCategory').value = 'Event';
                if (document.getElementById('galleryImage')) document.getElementById('galleryImage').value = '';
            ...
            function cancelEditCompany(e) {
                if (e && e.preventDefault) e.preventDefault();
                document.getElementById('editCompanyId').value = '';
                if (document.getElementById('compName')) document.getElementById('compName').value = '';
                if (document.getElementById('compIndustry')) document.getElementById('compIndustry').value = '';
                if (document.getElementById('compLogo')) document.getElementById('compLogo').value = '';
                if (document.getElementById('compTagline')) document.getElementById('compTagline').value = '';
                if (document.getElementById('compDesc')) document.getElementById('compDesc').value = '';
                if (document.getElementById('compLocation')) document.getElementById('compLocation').value = '';
                if (document.getElementById('compPackage')) document.getElementById('compPackage').value = '';
                if (document.getElementById('compRoles')) document.getElementById('compRoles').value = '';
                if (document.getElementById('compWebsite')) document.getElementById('compWebsite').value = '';
                if (document.getElementById('compTags')) document.getElementById('compTags').value = '';
                document.getElementById('companyFormTitle').textContent = 'Add Company';
                const submitBtn = document.getElementById('companySubmitBtn');
                if (submitBtn) submitBtn.innerHTML = '<i class="fa-solid fa-plus me-1"></i> Add Company';
                    ...
                    <div class="modal-body p-4">
                        <div id="sendMailForm">
                            ...
                            <div class="mt-3 text-end">
                                ...
                                <button type="button" class="btn btn-rku btn-sm" onclick="sendStudentPlacementMail(event)">
