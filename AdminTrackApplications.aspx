<%@ Page Title="" Language="C#" MasterPageFile="~/Admin-panel.Master" AutoEventWireup="true" CodeBehind="AdminTrackApplications.aspx.cs" Inherits="RKU_PLACEMENT_PORTAL.AdminTrackApplications" %>
        ...
        <div class="wrapper">
            ...
            <aside class="sidebar" id="sidebar">
                <div>
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="sidebar-item active" data-tab="tab-track-applications"><a href="AdminTrackApplications.aspx"><i class="fa-solid fa-list-check"></i>Application Tracker</a> </li>
            ...
            <div class="main-panel">
                ...
                <main class="content-container">
                    ...
                    <div id="tab-track-applications" class="tab-pane-content active">
                <div class="row g-4">
                    <div class="col-md-4">
                        <div class="dashboard-card">
                            <h5 class="fw-bold mb-3">Select Placement Drive</h5>
                            <p class="text-muted small">
                                Choose a drive to view and manage applied student profiles.
                            </p>
...
<!-- Application Tracker JavaScript Controller -->
<script>
