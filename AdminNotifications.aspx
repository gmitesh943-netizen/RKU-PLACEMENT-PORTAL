<%@ Page Title="" Language="C#" MasterPageFile="~/Admin-panel.Master" AutoEventWireup="true" CodeBehind="AdminNotifications.aspx.cs" Inherits="RKU_PLACEMENT_PORTAL.AdminNotifications" %>
             ...
             ========================================== -->
                        <aside class="sidebar" id="sidebar">
                            <div>
                                ...
                                <ul class="sidebar-menu">
                                    ...
                                    <li class="sidebar-item active" data-tab="tab-notifications"><a href="AdminNotifications.aspx"><i class="fa-regular fa-bell"></i>Send Broadcast</a> </li>
                        ...
                        <div class="main-panel">
                            ...
                            <main class="content-container">
                                ...
                                <div id="tab-notifications" class="tab-pane-content active">
                                    <div class="row g-4">
                                        <div class="col-md-5">
                                            <div class="dashboard-card">
                                                ...
                                                <div id="announcementForm">
                                                    ...
                                                    <button type="button" class="btn btn-rku btn-sm w-100" onclick="postBroadcast(event)">
                                ...
                                <!-- ─── END BROADCAST NOTIFICATIONS TAB ─── -->
                    ...
                    <!-- Broadcast Notifications JavaScript Controller -->
                    <script>
            ...
            `;
                ...
                `;
                        ...
                        function postBroadcast(e) {
                            ...
                            if (!title)   { showAnnMsg('Broadcast Subject is required.', 'danger'); document.getElementById('annTitle').focus(); return; }
                            if (!message) { showAnnMsg('Notification Message is required.', 'danger'); document.getElementById('annMessage').focus(); return; }

                            PortalDB.addAnnouncement(title, message);
                            showAnnMsg('Notice broadcasted to all students successfully!', 'success');
                        ...
                        function showAnnMsg(msg, type) {
                            var ex = document.getElementById('annAlert');
                            if (ex) ex.remove();
                            var el = document.createElement('div');
                            el.id = 'annAlert';
                            el.className = 'alert alert-' + type + ' alert-dismissible py-2 mt-2 small';
                            el.innerHTML = msg + '<button type="button" class="btn-close btn-sm" onclick="this.parentElement.remove()"></button>';
                            document.getElementById('announcementForm').appendChild(el);
